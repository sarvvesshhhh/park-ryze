...
export default function PhysicalLayoutDrawer() {
  ...
  const baseFare = lot.hourlyRate * selectedDurationHours;
  const platformFee = 5;
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end pointer-events-none">
      ...
      <div
        onClick={closeDrawer}
        className="fixed inset-0 bg-black/65 backdrop-blur-sm pointer-events-auto transition-opacity"
      />
      ...
      <aside className="pointer-events-auto relative w-full md:max-w-2xl lg:max-w-3xl h-[92vh] md:h-full mt-auto md:mt-0 bg-[#0f131c] border-t md:border-t-0 md:border-l border-[#2B313E] shadow-2xl flex flex-col z-10 overflow-hidden rounded-t-3xl md:rounded-none animate-in slide-in-from-bottom md:slide-in-from-right duration-300">
        ...
        <div className="p-4 md:p-6 bg-[#161a23] border-b border-[#2B313E] shrink-0">
          <div className="flex items-start justify-between gap-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[11px] text-on-surface-variant">CAD Grid</span>
              </div>
          ...
          {/* Security Gate Directive Banner */}
          <div className="mt-3 p-2.5 rounded-lg bg-[#111620] border border-[#2B313E] flex items-start gap-2.5 text-xs text-on-surface-variant">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-6 bg-[#0a0e16] space-y-6">
          <div className="flex items-center justify-between text-xs font-mono text-on-surface-variant">
            ...
            <span className="text-[11px] text-slate-500 hidden sm:inline">Tap bay to inspect & book</span>
          </div>
          ...
          <div className="relative border-2 border-[#2B313E] rounded-xl p-4 md:p-6 bg-[#11141c] shadow-2xl overflow-x-auto">
            ...
            <div className="flex justify-between items-center pb-3 mb-4 border-b border-[#232834] font-mono text-[11px] text-slate-500">
              <span>SECTION A-B // STILT LEVEL 0</span>
              <span className="tracking-widest">▲ NORTH GULMOHAR RD</span>
            </div>

            {/* TOP ROW: BAYS A-01 TO A-08 */}
            <div className="mb-4">
              <div className="font-mono text-[10px] text-slate-500 mb-1.5 uppercase tracking-wider">
                ROW A — COVERED STILT
              </div>
            ...
            <div className="relative my-6 py-4 bg-[#161a24] border-y-2 border-yellow-500/70 border-dashed rounded min-w-[540px]">
              ...
              {/* Cross-Hatched Concrete Pillars (Obstacles) */}
        ...
        {/* Floating Checkout / Duration Panel (Stitch CAD Checkout Spec) */}
        <div className="p-4 md:p-6 bg-[#141822] border-t border-[#2B313E] shrink-0 shadow-[0_-12px_24px_rgba(0,0,0,0.6)]">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
            <div>
              ...
              <p className="text-xs text-on-surface-variant font-sans">
                Standard Clearance • {selectedBay.vehicleSize.toUpperCase()}
              </p>
            </div>
          ...
          <div className="mb-4">
            <div className="font-mono text-[11px] text-on-surface-variant uppercase tracking-wider mb-2 flex justify-between">
              <span>Duration</span>
              <span className="text-emerald-400 font-semibold">₹{lot.hourlyRate}/hr</span>
            </div>
          ...
          <div className="bg-[#0b0f17] border border-[#2B313E] rounded-xl p-3 mb-4 space-y-1.5 text-xs font-mono">
            <div className="flex justify-between text-on-surface-variant">
              <span>Parking Fare ({selectedDurationHours} hrs × ₹{lot.hourlyRate})</span>
              <span className="text-white">₹{baseFare}</span>
            </div>
            <div className="flex justify-between text-on-surface-variant">
              <span>Convenience & Fastag Sync</span>
              <span className="text-white">₹{platformFee}</span>
            </div>
            <div className="pt-2 border-t border-[#232834] flex justify-between text-sm font-bold">
              <span className="text-white">Total Amount</span>
              <span className="text-emerald-400 text-base">₹{totalFare}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
            ...
            >
              <span>Reserve Bay {selectedBay.id} for ₹{totalFare}</span>
